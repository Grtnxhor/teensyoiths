            ...
            <div class="row">
                <div class="col-12">
                    <div class="hero-slides-content">
                        <h2 data-animation="fadeInUp" data-delay="100ms">A mail is coming</h2>
                        <p data-animation="fadeInUp" data-delay="300ms">Kindly check your email inbox or your spam
                            folder for a reset link</p>
                    </div>
                </div>
            </div>
        </div>
