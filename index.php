            ...
            <div class="row">
                <div class="col-12">
                    <div class="hero-slides-content">
                        ...
                        <a href="./signup" class="btn crose-btn" data-animation="fadeInUp" data-delay="500ms">Join the
                            Revolution Now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="hero-slides-content">
                        ...
                        <p data-animation="fadeInUp" data-delay="300ms">Join the revolution of teens, young adult, and
                            youths</p>
                        <a href="./signup" class="btn crose-btn" data-animation="fadeInUp" data-delay="500ms">Join the
                            Revolution Now</a>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="section-heading">
                    <h2>About US</h2>
                    <p>TeensYouths® is a vibrant community for teens & youths from all over the world, offering
                        inspiring insight and opinion on a variety of topics.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row about-content justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="about-us-content mb-100">
                    ...
                    <div class="about-text">
                        <h4>Who we are</h4>
                        <p>We are committed to sharing insightful articles, opinions, and materials that will help teens
                            and youths become all they can be, leveraging the opportunities around and within them.</p>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="about-us-content mb-100">
                    ...
                    <div class="about-text">
                        <h4>What we do</h4>
                        <p>We’re committed to sharing inspiring and life-transforming articles to help change your life
                            for good.</p>
                        <a href="./about">Read More <i class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="about-us-content mb-100">
                    ...
                    <div class="about-text">
                        ...
                        <p>Join the revolution of teens, young adult, and youths. TeensYouths® is a vibrant community
                            for teens & youths from all over the world, offering inspiring insight and opinion on a
                            variety of topics.</p>
                        <a href="./about">Read More <i class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post mb-100">
                    <div class="post-thumbnail">
                        <a style="text-decoration: none;" href="<?php echo $row['post_url']; ?>"><img
                                style="width: 100%; height: 300px;" src="<?php echo $row['pix']; ?>" alt=""></a>
                    </div>
                    <div class="post-content">
                        ...
                        <div class="post-meta d-flex">
                            <a style="text-decoration: none;" href="#"><i class="fa fa-user" aria-hidden="true"></i>
                                <?php echo $row['author']; ?></a>
                            <a style="text-decoration: none;" href="#"><i class="fa fa-eye" aria-hidden="true"></i>
                                <?php echo $row['view']; ?></a>
                        </div>
                                ...
                                <div class="upcoming-events-content d-flex flex-wrap align-items-center">
                                    <div class="events-text">
                                        ...
                                        <div class="events-meta">
                                            <a style="text-decoration: none" href="#"><i class="fa fa-calendar"
                                                    aria-hidden="true"></i>
                                                <?php echo date('D, M d, Y', strtotime($row2['datepost'])) ?></a>
                                            <a style="text-decoration: none" href="#"><i class="fa fa-eye"
                                                    aria-hidden="true"></i> <?php echo $row2['view']; ?></a>
                                        </div>
                                        <p><?php echo htmlspecialchars($y); ?></p>
                                    </div>
