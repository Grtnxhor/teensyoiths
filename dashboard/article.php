        ...
        <div class="card card-dark">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" id="edit" data-toggle="modal" data-target="#modal-edit" data-toggle="tooltip"
                        title="Edit a question" class="btn btn-tool"><i class="fas fa-edit"></i>
                    </button>
                    <button type="button" id="del" data-toggle="modal" data-target="#modal-delete" data-toggle="tooltip"
                        title="Delete a question" class="btn btn-tool"><i class="fas fa-trash"></i>
                    </button>
 ...
 while($row = mysqli_fetch_array($result_set))
 {
  if(row_count($result_set) == "") {
          ...
          ?>
                            ...
                            <td><?php echo number_format($row['totview']); ?></td>
                            <td><?php echo date('D, M d, Y h:i:sa', strtotime($row['datepost'])) ; ?></td>
                            <td><a href="https://teensyouths.com.ng/<?php echo $row['post_url']; ?>">View article
                                    details</a></td>
                            </td>
                        </tr>
                        <?php
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-danger">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <p class="text-grey">Kindly confirm the article you want to delete by selecting from the list of
                        articles below</p>
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-info">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <p class="text-grey">Kindly confirm the article you wish to edit by selecting from the list of
                        articles below</p>
