...
if (isset($_GET['id'])) {
  ...
  $ssl = "SELECT * FROM article WHERE `author` = '$author' AND `post_url` = '$data'";
  $ghl = query($ssl);
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="svptit" class="form-control" value="<?php echo $row['title'] ?>" placeholder="Enter your article title">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <label>Article Details</label>
                         <textarea style="white-space: pre-wrap;" class="textarea" id="svpdet"  data-parsley-pattern="/<\s*((p|span|ul|li|i|u|b)1?)[>]*\s*>/" placeholder="Place some text here"
