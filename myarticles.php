                        ...
                        <div class="events-text">
                            ...
                            <div class="events-meta">
                                <a style="text-decoration: none;" href="#"><i class="fa fa-calendar"
                                        aria-hidden="true"></i>
                                    <?php echo date('D, M d, Y  h:i:sa', strtotime($row['datepost'])) ?></a>
                                <a style="text-decoration: none;"
                                    href="./edit?id=<?php echo $row['post_url']; ?>&lead=<?php echo $row['id']; ?>"><i
                                        class="fa fa-edit" aria-hidden="true"></i> Edit</a>
                                <a style="text-decoration: none;"
                                    href="./delete?id=<?php echo $row['post_url']; ?>&lead=<?php echo $row['id']; ?>"><i
                                        class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                <p id="tsr" hidden><?php echo $row['id']; ?></p>
                            ...
                            <div class="share">
                                ...
                                <a target="_blank" data-media="<?php echo $row['pix']; ?>"
                                    href="https://facebook.com/sharer.php?u="><i class="fa fa-facebook"
                                        aria-hidden="true"></i></a> &nbsp;&nbsp;&nbsp;
                                <a target="_blank" data-media="<?php echo $row['pix']; ?>"
                                    href="https://twitter.com/home?status="><i class="fa fa-twitter"
                                        aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;
                                <a target="_blank" data-media="<?php echo $row['pix']; ?>"
                                    href="https://api.whatsapp.com/send?text="><i class="fa fa-whatsapp"
                                        aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div class="find-out-more-btn">
