    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 breadcrumbs text-center">
                ...
                <p><span><a href="./">Home</a></span> / <span><a href="./articles">Articles </a></span> / <span>Article
                        Details</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="blog-entry">
                            ...
                            <div class="desc">
                                ...
                                <ul class="colorlib-social-icons">
                                    ...
                                    <li><a target="_blank" data-media="<?php echo $row['pix']; ?>"
                                    ...
                                    <li><a target="_blank" data-action="share/whatsapp/share"
                                            data-media="<?php echo $row['pix']; ?>"
                        ...
                        <div class="review">
                            ...
                            <div class="desc">
                                <h4>
                                    ...
                                    <span
                                        class="text-right"><?php echo date('D, M d, Y  ', strtotime($row3['date'])) ?></span>
                                </h4>
                        ...
                        <form action="#">
                            <div class="row form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="cfname" class="form-control"
                            ...
                            <input id="cpost" type="text" class="form-control" id="contact-email" placeholder="Email"
                                value="<?php echo $data ?>" hidden>

                            <div class="row form-group">
                                <div class="col-md-12">
                                    <!-- <label for="message">Message</label> -->
                                    <textarea name="message" id="cxt" cols="30" rows="10" class="form-control"
            ...
            <div class="col-md-3">
                ...
                ?>
                        <div class="f-blog">
                            <a href="<?php echo $row2['post_url']; ?>" class="blog-img"
                                style="background-image: url(<?php echo $a; ?>);">
                            </a>
                            <div class="desc">
