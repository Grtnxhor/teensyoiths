...
if (!isset($_GET['id']) && !isset($_GET['lead'])) {
    ...
    $data = $_GET['id'];
    $lead = $_GET['lead'];
$sql = "SELECT * FROM article WHERE `post_url` = '$data' AND `id` = '$lead'";
$res = query($sql);
if (row_count($res) == "") {
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input style="color:black" name="title" type="text"
                                                    ...
                                                    id="contact-name" placeholder="Input your article title here"
                                                    required>
                                            </div>
                                        </div>

                                        <input name="idn" type="text" value="<?php echo $row['id'] ?>"
                                            class="form-control" id="contact-name"
                                            placeholder="Input your article title here" hidden>
                                        ...
                                        <div class="col-12 text-center">
                                            <button name="update" type="submit"
                                                class="btn crose-btn mt-15">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
